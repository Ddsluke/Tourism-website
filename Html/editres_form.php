...
<form action="php/edit_res.php" method="post">
<ul class="form_input">
...
<input id="price" type="number" name="AveragePrice" onclick="checkPrice()" placeholder="0" required name="price" min="0" value="0" step="0.01" title="Currency" pattern="^\d+(?:\.\d{1,2})?$">
</li>
