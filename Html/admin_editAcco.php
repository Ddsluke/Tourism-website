...
<div class="form_container">
  <h1>Edit accommodation information</h1>
  <form action="/action_page.php" method="post">
	<ul class="form_input">
	
		<li>
        <label for="">ID</label>
		<input type="text" id="id" placeholder="Accommodation's ID.." title="No longer than 8 characters" maxlength="8">
		</li>
		<li>
        <label for="">Name</label>
		<input type="text" id="name" placeholder="Accommodation's name.." title="No longer than 50 characters" maxlength="50">
		</li>
		...
		<input name="price" type="number" onclick="checkPrice()" placeholder="0" required name="price" min="0" value="0" step="0.01" title="Currency" pattern="^\d+(?:\.\d{1,2})?$">
		</li>
