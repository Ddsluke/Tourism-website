...
<li>
<label for="">ID</label>
<input type="text" id="id" name="TouristsID" placeholder="Tourists's ID.." title="No longer than 8 characters" maxlength="8">
</li>

<li>
<label for="">Name</label>
<input type="text" id="name" name="Username" placeholder="Username.." title="No longer than 50 characters" maxlength="50">
</li>

<li>
<label for="">Age</label>
<input type="number" id="age" name="Age" placeholder="User's age.." title="must be a valid number" maxlength="50">
</li>

<li>
<label for="">E-mail</label>
<input type="email" id="email" name="Email" placeholder="User's email.." title="must be a valid email" maxlength="50">
