...
header("Content-Type: text/html; charset=utf8");
    ...
    $Id = $_POST['Id'];//get Administor's name
    $Passowrd = $_POST['Password'];//get Administor's password

	

    if ($Id && $passowrd){//if both name and passowrd are not null
             $sql = "select * from Administor where Id = '$Id' and Password='$Passowrd'";//to check with database
             ...
             if($rows){//0 false 1 true
                ...
                /*echo "Administor name or password error";
                echo "
                    <script>
    ...
    }else{//if Administor Id or passowrd is empty
				?>
