...
<?php
    ...
    $in1="DELETE FROM Attractions_Type WHERE AID='$AID'";
    ...
    $in2= "DELETE FROM Attraction WHERE AID='$AID'";
    ...
    if (!$result){
        ...
        echo "<br>DELETE ID is: " . $AID;        //success
    }
    header("refresh:3;url=../deleteattr_form.php");
